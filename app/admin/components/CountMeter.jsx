...
import { useOrderssCount } from "@/lib/firestore/orders/read_count";
...
export default function CountMeter() {
    ...
    const { data: ordersCounts } = useOrderssCount();
    const amountRupees =  ordersCounts?.totalRevenue / 100;

    const numberOnly = amountRupees.toLocaleString('en-IN', {
    ...
    return (
        <section className="grid grid-cols-2 md:grid-cols-4 gap-5">
            ...
            <Card imgURL={"profit-up.png"} title={"Revenue"} value={`₹ ${numberOnly ?? 0}`} />
