    ...
    <div className="flex-1 flex flex-col gap-3 md:pr-5 md:px-0 px-5 rounded-xl w-full overflow-x-auto">
      ...
      <div className="flex justify-between text-sm py-2">
         ...
         <select 
           ...
           className="px-5 rounded-xl border-none " 
           name="perpage" 
           id="perpage"
          >
  ...
  return (
    <tr>
      ...
      <td className="border-y bg-white px-3 py-2">
        <div className="flex">
           {item?.stock - (item.orders ?? 0) > 0 && <div className="px-2 py-1 text-xs text-green-500 bg-green-100 rounded-md">Available</div>}
           {item?.stock - (item.orders ?? 0) <= 0 && <div className="px-2 py-1 text-xs text-red-500 bg-red-100 rounded-md">Out Of Stock</div>}
        </div>
      </td>
